...
export default function NotFound() {
  return (
    <div className="px-6 py-16 text-center">
      ...
      <h2 className="font-display text-lg font-extrabold text-ink mb-2">Page not found</h2>
      ...
      <Link
        href="/"
        className="inline-block bg-ink text-white rounded-button px-5 py-2.5 text-[13px]"
      >
        ← Back to the guide
      </Link>
    </div>
